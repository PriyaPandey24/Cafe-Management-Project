...
import net.proteanit.sql.DbUtils;
public class viewsell extends javax.swing.JFrame{
    public viewsell() {
        initComponents();
        ShowBills();
    }
    ...
    private void ShowBills()
    {
        try{
            ...
            Rs=st.executeQuery("select * from billb1");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewsell.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
